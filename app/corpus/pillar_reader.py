# =============================================================================
# OIC PillarReader — Load/Cache + slice_likelihood
...
from corpus.pillar_crosswalk import (
...
class PillarReader:
    ...
    def load(self, force: bool = False) -> None:
        ...
        One bad file logs and skips — never breaks startup.
        """
        with self._lock:
    ...
    def slice_likelihood(self, industry: str) -> dict:
        ...
        Never raises. Never derives a probability (see spec §8).
    ...
    def coverage_report(self) -> Dict[str, dict]:
        ...
        """
        from corpus.pillar_crosswalk import canonical_industries
